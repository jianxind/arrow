...
SUM_KERNEL_BENCHMARK(SumKernelUInt8, UInt8Type);
SUM_KERNEL_BENCHMARK(SumKernelUInt16, UInt16Type);
SUM_KERNEL_BENCHMARK(SumKernelUInt32, UInt32Type);
SUM_KERNEL_BENCHMARK(SumKernelUInt64, UInt64Type);
